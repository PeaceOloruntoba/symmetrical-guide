...
@section('content')
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="p-4">
            <h1 class="text-2xl font-semibold text-gray-800 mb-4">Create New Plan</h1>
            ...
            <form action="{{ route('admin.plans.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="currency" id="currency" value="{{ old('currency', 'USD') }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        required>
                ...
                <div class="mb-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="has_chat" id="has_chat" value="1" {{ old('has_chat') ? 'checked' : '' }} class="mr-2">
                ...
                <div class="mb-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="has_company_list" id="has_company_list" value="1" {{ old('has_company_list') ? 'checked' : '' }} class="mr-2">
                ...
                <div class="mb-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="has_product_page" id="has_product_page" value="1" {{ old('has_product_page') ? 'checked' : '' }} class="mr-2">
                ...
                <div class="mb-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="has_wallet_system" id="has_wallet_system" value="1" {{ old('has_wallet_system') ? 'checked' : '' }} class="mr-2">
                ...
                <div class="mb-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_popular" id="is_popular" value="1" {{ old('is_popular') ? 'checked' : '' }} class="mr-2">
